...
{
    public partial class UspSyngasSplit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string procedure = @"-- =============================================
-- Author:      <Author, Cognizant>
-- Create Date: <Create Date, 16-Jun-2021>
-- Description: <Description, Syngas flow KPI >
-- =============================================
CREATE PROCEDURE [dbo].[usp_SyngasSplit]
(
...
BEGIN
	...
	SELECT
		...
		p.SYNGAS_FLOW_ACT_VALUE,
		p.SYNGAS_FLOW_ACT_VALUE_UNIT,
		...
		'x 1000' as INDICATOR,							--Indicator
		'Total Syngas' as KPI_TITLE						--KPI Title

		FROM PlantKPI p INNER JOIN Convertor c
		ON p.Convertor_Convertor_SID = c.Convertor_SID
...
#pragma warning restore CA1062 // Validate arguments of public methods
        ...
        {
            string procedure = @"
Drop PROCEDURE [dbo].[usp_SyngasSplit]
(
    -- Add the parameters for the stored procedure here
    @sectionId varchar(10)
    --<@Param2, sysname, @p2> <Datatype_For_Param2, , int> = <Default_Value_For_Param2, , 0>
